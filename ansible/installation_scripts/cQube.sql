/*SELECT 'CREATE DATABASE cqubedev'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'cqubedev')\gexec;

SELECT '\c cqubedev'\gexec;

SELECT 'CREATE schema edu'\gexec;

SELECT 'set search_path to edu'\gexec;
*/
