...
class DikshaStackedReport(unittest.TestCase):
    ...
    def test_metrics(self):
        print("")
        all_last_30_days = DikshaStacked()
        df1 = pd.read_sql_query(all_last_30_days.overall_usage_last_30_days, self.connection)
       ...
       'content_subject', 'total_content_plays']]
        ...
        path = config['jsondata']['stack_bar_reports_last_30_day']
