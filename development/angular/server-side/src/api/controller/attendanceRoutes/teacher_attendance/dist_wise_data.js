...
router.post('/distWise', auth.authController, async function (req, res) {
    try {
        ...
        let fileName = `teacher_attendance/district_${year}_${month}.json`;
        ...
        res.status(200).send({ distData: distData, teacherCount: jsonData.allDistrictsFooter.teachers, schoolCount: jsonData.allDistrictsFooter.schools });
    } catch (e) {
