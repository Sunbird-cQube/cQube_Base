...
class Click_ChangePwd(unittest.TestCase):
    ...
    def test_set_negative_newpwd(self):
        ...
        self.driver.find_element_by_xpath(Data.new_pwd).send_keys("abcd123")
        time.sleep(2)
        self.driver.find_element_by_xpath(Data.conf_pwd).send_keys("abcd12")
        time.sleep(2)
        self.driver.find_element_by_xpath(Data.submit).click()
        time.sleep(3)
        print(self.driver.get_screenshot_as_file("errormsg.png"))
