...
class Choose6(unittest.TestCase):
    def setUp(self):
    ...
    def test_District(self):
        dist = self.driver.find_element_by_xpath(Data.dist6).click()
        blk = self.driver.find_element_by_xpath(Data.blk6).click()
        clus = self.driver.find_element_by_xpath(Data.clu6).click()

        print(self.driver.find_element_by_xpath(Data.dist6).text)
