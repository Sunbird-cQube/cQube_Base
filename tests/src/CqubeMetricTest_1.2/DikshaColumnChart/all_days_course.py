...
class DikshaColumnChartReport(unittest.TestCase):
    ...
    def test_course(self):
        ...
        print("No Difference between s3 bucket metrics and the metrics generated outside cqube for diksha column chart ")
