...
class Choose9(unittest.TestCase):
    def setUp(self):
    ...
    def test_District(self):
        dist = self.driver.find_element_by_xpath(Data.dist9).click()
        blk = self.driver.find_element_by_xpath(Data.blk4).click()
        clus = self.driver.find_element_by_xpath(Data.clu3).click()

        print(self.driver.find_element_by_xpath(Data.dist9).text)
        print(self.driver.find_element_by_xpath(Data.blk4).text)
