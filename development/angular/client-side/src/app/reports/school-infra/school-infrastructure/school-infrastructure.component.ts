...
export class SchoolInfrastructureComponent implements OnInit {
  ...
  createTable(dataSet, height) {
    ...
    $(document).ready(function () {
      ...
      $('#table').DataTable({
        ...
        bPaginate: false, scrollY: height > 1760 ? '68vh' : height > 1180 && height < 1760 ? '58vh' : height > 667 && height < 1180 ? '54vh' : '42vh', scrollX: true,
  ...
  createChart(labels, chartData, name, obj) {
    var ctx = $('#myChart');
    ctx.attr('height', this.height > 1760 ? '72vh' : this.height > 1180 && this.height < 1760 ? '66vh' : this.height > 667 && this.height < 1180 ? '60vh' : '52vh');
