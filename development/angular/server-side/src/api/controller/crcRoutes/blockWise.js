    ...
    try {
        ...
        for (i = 0; i < keys.length; i++) {
            ...
            let resultObj = {
                districtId: crcFrequencyGroupData[keys[i]][0].district_id,
                districtName: crcFrequencyGroupData[keys[i]][0].district_name,
                blockId: crcFrequencyGroupData[keys[i]][0].block_id,
                blockName: crcFrequencyGroupData[keys[i]][0].block_name,
            ...
            let schoolData = crcMetaDataGroupData[resultObj.blockId];
            crcMetadataFilteredSchool = schoolData.length;

            // to find the distinct cluster_id of crc meta data for each block
