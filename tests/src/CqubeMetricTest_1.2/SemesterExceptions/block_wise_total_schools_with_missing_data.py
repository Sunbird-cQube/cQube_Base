...
class Semester(unittest.TestCase):
    ...
    def test_metrics(self):
        ...
        df1=df1[['block_id', 'block_name','total_schools_with_missing_data']]
        ...
        df2 = df2[['block_id', 'block_name', 'total_schools_with_missing_data']]
        ...
        assert df_diff.empty , "Found difference between s3 bucket metrics and the metrics generated outside cqube for block wise total_schools_with_missing_data"
        print("No Difference between s3 bucket metrics and the metrics generated outside cqube for block wise total_schools_with_missing_data for semester exception")
