...
create table if not exists udise_sch_profile_dup( udise_sch_code bigint primary key , ac_year text, address varchar(100), c0_sec smallint, c1_sec smallint, c2_sec smallint, c3_sec smallint, c4_sec smallint, c5_sec smallint, c6_sec smallint, c7_sec smallint, c8_sec smallint, c9_sec smallint, c10_sec smallint, c11_sec smallint, c12_sec smallint, estd_year varchar(10), recog_year_pri varchar(10), recog_year_upr varchar(10), recog_year_sec varchar(10), recog_year_hsec varchar(10), upgrd_year_ele varchar(10), upgrd_year_sec varchar(10), upgrd_year_hsec varchar(10), cwsn_sch_yn smallint, shift_sch_yn smallint, resi_sch_yn smallint, resi_sch_type int, boarding_pri_yn smallint, boarding_pri_b smallint, boarding_pri_g smallint, boarding_upr_yn smallint, boarding_upr_b smallint, boarding_upr_g smallint, boarding_sec_yn smallint, boarding_sec_b smallint, boarding_sec_g smallint, boarding_hsec_yn smallint, boarding_hsec_b smallint, boarding_hsec_g smallint, minority_yn smallint, minority_type smallint, mtongue_pri smallint, medinstr1 smallint, medinstr2 smallint, medinstr3 smallint, medinstr4 smallint, medinstr_oth varchar(100), lang1 smallint, lang2 smallint, lang3 smallint, prevoc_yn smallint, eduvoc_yn smallint, board_sec smallint, board_sec_no varchar(100), board_sec_oth varchar(100), board_hsec smallint, board_hsec_no varchar(100), board_hsec_oth varchar(100), distance_pri double precision, distance_upr double precision, distance_sec double precision, distance_hsec double precision, approach_road_yn smallint, ppsec_yn smallint, ppstu_lkg_b smallint, ppstu_lkg_g smallint, ppstu_ukg_b smallint, ppstu_ukg_g smallint, anganwadi_yn smallint, anganwadi_code varchar(100), anganwadi_stu_b smallint, anganwadi_stu_g smallint, anganwadi_tch_trained smallint, workdays_pre_pri smallint, workdays_pri smallint, workdays_upr smallint, workdays_sec smallint, workdays_hsec smallint, sch_hrs_stu_pre_pri double precision, sch_hrs_stu_pri double precision, sch_hrs_stu_upr double precision, sch_hrs_stu_sec double precision, sch_hrs_stu_hsec double precision, sch_hrs_tch_pre_pri double precision, sch_hrs_tch_pri double precision, sch_hrs_tch_upr double precision, sch_hrs_tch_sec double precision, sch_hrs_tch_hsec double precision, cce_yn_pri smallint, cce_yn_upr smallint, cce_yn_sec smallint, cce_yn_hsec smallint, pcr_maintained_yn smallint, pcr_shared_yn smallint, rte_25p_applied smallint, rte_25p_enrolled smallint, rte_pvt_c0_b smallint, rte_pvt_c0_g smallint, rte_pvt_c1_b smallint, rte_pvt_c1_g smallint, rte_pvt_c2_b smallint, rte_pvt_c2_g smallint, rte_pvt_c3_b smallint, rte_pvt_c3_g smallint, rte_pvt_c4_b smallint, rte_pvt_c4_g smallint, rte_pvt_c5_b smallint, rte_pvt_c5_g smallint, rte_pvt_c6_b smallint, rte_pvt_c6_g smallint, rte_pvt_c7_b smallint, rte_pvt_c7_g smallint, rte_pvt_c8_b smallint, rte_pvt_c8_g smallint, rte_bld_c0_b smallint, rte_bld_c0_g smallint, rte_bld_c1_b smallint, rte_bld_c1_g smallint, rte_bld_c2_b smallint, rte_bld_c2_g smallint, rte_bld_c3_b smallint, rte_bld_c3_g smallint, rte_bld_c4_b smallint, rte_bld_c4_g smallint, rte_bld_c5_b smallint, rte_bld_c5_g smallint, rte_bld_c6_b smallint, rte_bld_c6_g smallint, rte_bld_c7_b smallint, rte_bld_c7_g smallint, rte_bld_c8_b smallint, rte_bld_c8_g smallint, rte_ews_c9_b smallint, rte_ews_c9_g smallint, rte_ews_c10_b smallint, rte_ews_c10_g smallint, rte_ews_c11_b smallint, rte_ews_c11_g smallint, rte_ews_c12_b smallint, rte_ews_c12_g smallint, spltrg_yn smallint, spltrg_cy_prov_b smallint, spltrg_cy_prov_g smallint, spltrg_py_enrol_b smallint, spltrg_py_enrol_g smallint, spltrg_py_prov_b smallint, spltrg_py_prov_g smallint, spltrg_by smallint, spltrg_place smallint, spltrg_type smallint, remedial_tch_enrol smallint, session_start_mon smallint, txtbk_recd_yn smallint, txtbk_recd_mon smallint, supp_mat_recd_yn smallint, txtbk_pre_pri_yn smallint, txtbk_pri_yn smallint, txtbk_upr_yn smallint, txtbk_sec_yn smallint, txtbk_hsec_yn smallint, tle_pre_pri_yn smallint, tle_pri_yn smallint, tle_upr_yn smallint, tle_sec_yn smallint, tle_hsec_yn smallint, playmat_pre_pri_yn smallint, playmat_pri_yn smallint, playmat_upr_yn smallint, playmat_sec_yn smallint, playmat_hsec_yn smallint, no_inspect smallint, no_visit_crc smallint, no_visit_brc smallint, no_visit_dis smallint, smc_yn smallint, smc_mem_m smallint, smc_mem_f smallint, smc_par_m smallint, smc_par_f smallint, smc_par_sc smallint, smc_par_st smallint, smc_par_ews smallint, smc_par_min smallint, smc_lgb_m smallint, smc_lgb_f smallint, smc_tch_m smallint, smc_tch_f smallint, smc_trained_m smallint, smc_trained_f smallint, smc_meetings smallint, smc_sdp_yn smallint, smc_bnkac_yn smallint, smc_bnk_name varchar(100), smc_bnk_br varchar(100), smc_bnkac_no varchar(100), smc_bnkac_ifsc varchar(100), smc_bnkac_name varchar(100), smdc_smc_same_yn smallint, smdc_yn smallint, smdc_mem_m smallint, smdc_mem_f smallint, smdc_par_m smallint, smdc_par_f smallint, smdc_par_ews_m smallint, smdc_par_ews_f smallint, smdc_lgb_m smallint, smdc_lgb_f smallint, smdc_ebmc_m smallint, smdc_ebmc_f smallint, smdc_women_f smallint, smdc_scst_m smallint, smdc_scst_f smallint, smdc_deo_m smallint, smdc_deo_f smallint, smdc_audit_m smallint, smdc_audit_f smallint, smdc_subexp_m smallint, smdc_subexp_f smallint, smdc_tch_m smallint, smdc_tch_f smallint, smdc_vp_m smallint, smdc_vp_f smallint, smdc_prin_m smallint, smdc_prin_f smallint, smdc_cp_m smallint, smdc_cp_f smallint, smdc_trained_m smallint, smdc_trained_f smallint, smdc_meetings smallint, smdc_sdp_yn smallint, smdc_bnkac_yn smallint, smdc_bnk_name varchar(100), smdc_bnk_br varchar(100), smdc_bnkac_no varchar(100), smdc_bnkac_ifsc varchar(100), smdc_bnkac_name varchar(100), smdc_sbc_yn smallint, smdc_acadcom_yn smallint, smdc_pta_yn smallint, smdc_pta_meeting smallint ,num_of_times int,ff_uuid varchar(255),created_on_file_process timestamp default current_timestamp);
