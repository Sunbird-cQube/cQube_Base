...
from Sanity_test.Change_Password import Change_password_Page, Click_on_Changepassword_without_newPassword, \
    Click_on_changepwd, Negative_changepwd, set_new_password, Set_up_new_password
from Sanity_test.Login import Invalid_credentials_check, Login_and_logout, Login_Negative_test, \
...
from Sanity_test.SR.Clusterwise_validation import Block_cluster, click_on_Cluster_validation, \
...
from Sanity_test.SR import District_dataTest,District_dots,DistrictNames,Dots_check, \
...
class MyTestSuite(unittest.TestCase):
    ...
    def test_Issue(self):
        ...
        runner1 = HTMLTestRunner.HTMLTestRunner(
            ...
            title='Test Report',
            verbosity = 1,
            description='Sanity Test Report'
