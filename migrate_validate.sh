...
declare -a arr=("installation_host_ip" "remote_system_user_name" "base_dir" "remote_db_user" "remote_db_name" "remote_storage_type" "mode_of_installation" "s3_access_key" "s3_secret_key" "aws_default_region" "remote_s3_output_bucket" "remote_output_directory" "cqube_cloned_path")
